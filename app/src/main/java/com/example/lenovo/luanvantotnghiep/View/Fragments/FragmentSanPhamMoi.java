...
import com.example.lenovo.luanvantotnghiep.Presenter.PresentersLogic.PresenterLogicSanPhamMoi;
...
public class FragmentSanPhamMoi extends Fragment implements IViewSanPhamMoi {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterLogicSanPhamMoi.layDanhSachSPMoi();
        return  view ;
    ...
    public void hienThiDanhSachSPMoi(List<SanPham> sanPhams) {
        ...
        adapterSanPham = new AdapterSanPham(getContext(),sanPhamList,R.layout.custom_recyclerview_sanphammoi);
